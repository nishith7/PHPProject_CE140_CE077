	    ...
	    <div class="container">
	        <div class="row">
	            <div class="col-sm-12 col-sm-12">
	                <h1 class="h1">
	                    Contact us <small>Feel free to contact us or send a feedback</small></h1>
	            </div>
	        </div>
	    </div>
	</div>
	<div class="container">
	    <div class="row">
	        <div class="col-md-4">
	            ...
	            <address>
	                <strong>Nishith & Nikunj</strong><br>
	                Rajkot & Junagadh<br>
	            ...
	            <address>
	                Email: <a href="nikunjhudka06@gmail.com">nikunjhudka06@gmail.com </a>
	            </address>
	            </form>
	        </div>
	    </div>
